...
### Question 1: Mathematical Precedence ⭐

What will this code output? Predict before revealing.
```python
print(10 - 3 * 2 ** 2)
```
...
2. Multiplication next: `3 * 4 = 12`
3. Subtraction last: `10 - 12 = -2`
</details>

---

### Question 2: The Truthiness of `and` ⭐⭐
...
#### 🔍 Explanation
Python evaluates truthiness. `5` is non-zero (Truthy). Because it's an `and` statement, Python must check the second value to confirm. It evaluates and returns the **last checked value**, which is `10`.
</details>

---

### Question 3: Short-Circuit Debugging ⭐⭐⭐ (HOTS)
...
3. Python completely **skips** evaluating `10 / x`, preventing the division-by-zero crash.
</details>
